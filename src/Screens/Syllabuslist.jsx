...
import Syllabus from '../component/Syllabus/Sylabus';
...
function Sylabuslist(props) { 
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      >
        <Toolbar />
        <div className='stdlist'> {/* Keep your existing content structure */}
...
Sylabuslist.propTypes = {
  window: PropTypes.func,
};

export default Sylabuslist;